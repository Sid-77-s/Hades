          ...
          <div key={message.id} className={message.role === 'user' ? "flex justify-end" : "flex gap-3"}>
            ...
            {message.role === 'hades' ? (
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 space-y-1.5 text-[13px] leading-relaxed text-slate-200 whitespace-pre-wrap">
                  {message.text}
                </div>
              </div>
            ) : (
              <div className="flex items-end gap-2.5">
                <div className="text-right">
                  ...
                  <p className="rounded-md rounded-br-sm border border-ion/30 bg-ion/[0.08] px-3.5 py-2 text-[13px] text-slate-100 whitespace-pre-wrap text-left">
                    {message.text}
                  </p>
                </div>
                <img
