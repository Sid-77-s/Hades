...
export function Composer({ onSendMessage }: ComposerProps) {
  ...
  return (
    <form
      ...
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-ion/30 bg-ion/[0.08]">
        <HadesMark size={22} />
      </span>
      ...
      <div className="flex items-center gap-1">
        ...
        <button type="button" className={utility} aria-label="Voice input">
